...
export class TestComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('canvas', { static: true }) public canvas: ElementRef | any;
  ...
  drawOnCanvas(previousPosition: { x: number, y: number }, currentPosition: { x: number, y: number }) {
  ...
  getImage(canvasHtmlElement: HTMLCanvasElement) {
